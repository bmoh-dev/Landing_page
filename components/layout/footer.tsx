...
function SocialIcon({
  ...
  return (
    <a
      ...
      aria-label={label}
      className="flex h-9 w-9 items-center justify-center rounded-button border border-border bg-card text-muted-foreground transition-all duration-200 hover:border-primary-300 hover:text-primary-600 hover:shadow-sm"
    >
      {children}
    </a>
  );
